...
namespace Dupes_Cuisine
{
    public class SunnyWheat_Plant_Config : IEntityConfig
    {
        ...
        public const float TemperatureWarningLow = 308.15f;       //-> 35°C <- crop stops growing
        public const float TemperatureWarningHigh = 333.15f;      //-> 60°C <- crop stops growing
        public const float TemperatureLethalHigh = 338.15f;       //-> 65°C <- crop dies
